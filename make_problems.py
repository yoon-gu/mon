...
TEMPLATE = "\item ~ \\newline \opadd[resultstyle=\placeholder,carrystyle=\color{{white}},displayintermediary=None]{{{input1}}}{{{input2}}}"
MULT_TEMPLATE = "\item ~ \\newline \opmul[resultstyle=\placeholder,carrystyle=\color{{white}},displayintermediary=None]{{{input1}}}{{{input2}}}"
...
import time
time.sleep(1)
os.system('cp example.pdf add_problem.pdf')
...
os.system('pdflatex example.tex')
time.sleep(1)
os.system('cp example.pdf add_problem_solution.pdf')